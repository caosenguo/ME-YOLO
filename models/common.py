...
class Upsample(nn.Module):
    ...
    def __init__(self, c1, c2, scale_factor=2):
        ...
        if scale_factor == 2:
            ...
            self.cv1 = nn.ConvTranspose2d(c1, c2, 8, 8, 0, bias=True)  # nn.Upsample(scale_factor=4, mode='nearest')
...
class EPSA(nn.Module):
    ...
    def __init__(self, c1, c2, e=0.5):
        ...
        self.attn1 = Attention(self.c // 2, attn_ratio=0.5, num_heads=self.c // 64)

        self.ffn = nn.Sequential(
            # Conv(self.c, self.c, 7, g=self.c),
        ...
        self.ffn1 = nn.Sequential(
            ...
            Conv(self.c, self.c // 2, 1, act=False)
        )
    ...
    def forward(self, x):
        ...
        m, n = self.cv3(b).split((self.c // 2, self.c // 2), dim=1)
        n1 = n + self.attn1(n)
        n = n + self.ffn1(n1)
        return self.cv2(torch.cat((a, m, n), 1))